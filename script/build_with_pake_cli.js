...
let params = `node cli.js ${process.env.URL} --proxy-url http://cus-sslfast666.fastsdwan.com:447 --name ${process.env.NAME} --height ${process.env.HEIGHT} --width ${process.env.WIDTH}`;
